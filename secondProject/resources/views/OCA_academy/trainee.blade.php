...
<div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mt-4">
                <div class="card">
                    <img class="card-img-top" src="{{ $trainee['img']}}">
                    <div class="card-block">
                        <figure class="profile">
                            <img src="{{ $trainee['img']}}" class="profile-avatar" alt="">
                        </figure>
                        <h4 class="card-title mt-3">{{ $trainee['name'] }}</h4>
                        <div class="meta">
                            <p>{{ $trainee['birthday']}}</p>
                        </div>
                        <div class="card-text">
                           <a href="{{ $trainee['github account']}}"><i class="fab fa-github-square fa-2x"aria-hidden="true"></i></a>
                            <a href="{{ $trainee['linkedin']}}"><i class="fab fa-linkedin fa-2x"aria-hidden="true"></i></a>
                        </div>
                    </div>

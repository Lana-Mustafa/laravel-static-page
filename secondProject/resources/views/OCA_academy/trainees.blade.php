                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <figure class="profile">
                            <img src="{{ $value['img']}}" class="profile-avatar" alt="">
                        </figure>
                        <h4 class="card-title mt-3">{{ $value['name'] }}</h4>
                        <div class="meta">
                            <p>{{ $value['birthday']}}</p>
                        </div>
                        <div class="card-text">
                           <a href="{{ $value['github account']}}"><i class="fab fa-github-square fa-2x"aria-hidden="true"></i></a>
                            <a href="{{ $value['linkedin']}}"><i class="fab fa-linkedin fa-2x"aria-hidden="true"></i></a>
                        </div>
                    </div>
                    <div class="card-footer">
                        
                        <a href="/trainee{{$value['id']}}"class="btn btn-secondary ">show </a>
                    </div>
                </div>
            </div>
        @endforeach
